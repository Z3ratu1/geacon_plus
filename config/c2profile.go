...
var (
	...
	// PostClientIDType http-post.client.id's type, support header/parameter
	PostClientIDType = "parameter"
	// PostClientID http-post.client.id\//__cfduid
	// PostClientID http-post.client.id.parameter
